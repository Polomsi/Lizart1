package com.example.polo.lizart;
...
public class ActividadInicio extends Activity {
        ...
        btnIniciaSesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(tieneConexion()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ActividadInicio.this);
    ...
    private class hebraLogin extends AsyncTask<Void, Void, String>{
        ...
        protected void onPreExecute(){
            dialog = ProgressDialog.show(ActividadInicio.this, "",
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                Toast.makeText(ActividadInicio.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                Toast.makeText(ActividadInicio.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
            return respuesta;
            ...
            try{
                ...
                if(obj!=null){
                    if(obj.getInt("error")==0){
                        ...
                        Toast.makeText(ActividadInicio.this, obj.getString("aclaracion"), Toast.LENGTH_SHORT).show();
                    }
                }
            }catch(Throwable t){
                Toast.makeText(ActividadInicio.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
